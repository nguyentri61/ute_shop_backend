import { getMyOrders, getOrderItemByOrderId, checkOutCODService } from "../services/orderServices.js";
...
export const checkOutCOD = async (req, res) => {
    try {
        ...
        const { address, phone, cartItemIds, shippingVoucher, productVoucher } = req.body;
        ...
        const { order, orderItems } = await checkOutCODService(userId, address, phone, cartItemIds, result.summary.total);
